...
- **STM32端**: 负责主控制、PID调节和系统状态管理
- **控制板端**: 负责舵机控制、动作管理和位置反馈
...
- **多层通信**: MaixCam-STM32(115200)、STM32-控制板(9600)双层通信
...
### 主控制器
- **STM32F103C8T6**: 主控制器，负责系统管理和PID控制
- **MaixCamPro**: 图像处理单元，负责目标检测和坐标计算

### 控制系统
- **总线舵机控制板**: 专用舵机控制器，负责舵机通信和动作管理
- **串联舵机 x2**:
  - 水平舵机: 控制激光水平方向
  - 垂直舵机: 控制激光垂直方向
- **绿色激光器**: 安装在舵机云台上
...
- [📡 控制板通信协议](舵机通信协议/控制板协议.md) - 总线舵机控制板协议详解
