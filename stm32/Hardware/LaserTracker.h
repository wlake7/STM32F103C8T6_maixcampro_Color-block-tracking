...
/*=========================================================================================*/
/* PID控制参数宏定义 - 便于调试 */
#define PID_KP_H            0.8f        // 水平轴比例增益 (原 2.0 * 0.4)
#define PID_KI_H            0.08f       // 水平轴积分增益 (原 0.2 * 0.4)
#define PID_KD_H            0.0f        // 水平轴微分增益
#define PID_KP_V            0.4f        // 垂直轴比例增益 (原 1.0 * 0.4)
#define PID_KI_V            0.08f       // 垂直轴积分增益 (原 0.2 * 0.4)
